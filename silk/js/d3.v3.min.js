d3 = function() {
  ...
  function ht(n, t) {
    ...
    return e.parse = function(n, t) {
      ...
      for (var r, u, i = {}, a = {}, o = [], c = n.length, f = 0, s = 0;
        (r = e()) !== a;) {
  ...
  function Xt(n, t, e, r) {
    var u;
    if (null == n) u = e * La / 2, r.point(-La, u), r.point(0, u), r.point(La, u), r.point(La, 0), r.point(La, -u), r.point(0, -u), r.point(-La, -u), r.point(-La, 0), r.point(-La, u);
    ...
    function e(n) {
      ...
      return {
        ...
        point: function(s, h) {
          ...
          if (!e && (l = c = d) && n.lineStart(), d !== c && (g = r(e, p), (Lt(e, g) || Lt(p, g)) && (p[0] += Fa, p[1] += Fa, d = t(p[0], p[1]))), d !== c) f = 0, d ? (n.lineStart(), g = r(p, e), n.point(g[0], g[1])) : (g = r(e, p), n.point(g[0], g[1]), n.lineEnd()), e = g;
          else if (o && e && a ^ d) {
            var v;
    ...
    return function(c) {
      ...
      function f(n) {
        for (var t = 0, e = M.length, r = n[1], u = 0; e > u; ++u)
          for (var i = 1, a = M[u], o = a.length, c = a[0]; o > i; ++i) b = a[i], c[1] <= r ? b[1] > r && s(c, b, n) > 0 && ++t : b[1] <= r && s(c, b, n) < 0 && --t, c = b;
        return 0 !== t
      }
      ...
      function v(n, t) {
        ...
        var e = g(n, t);
        if (M && x.push([n, t]), q) _ = n, w = t, S = e, q = !1, e && (c.lineStart(), c.point(n, t));
  ...
  function Ze(n, t) {
    var e = n.length - 1;
    if (e)
      for (var r, u, i = n[0][0], a = n[0][1], o = n[e][0] - i, c = n[e][1] - a, l = -1; ++l <= e;) r = n[l], u = l / e, r[0] = t * r[0] + (1 - t) * (i + u * o), r[1] = t * r[1] + (1 - t) * (a + u * c);
    return Ie(n)
  }
  ...
  function gr(n, t) {
    ...
    return o[0] != c[0] || o[1] != c[1] ? (r.push("translate(", null, ",", null, ")"), u.push({
        ...
        i: e - 2,
        x: hr(g[1], p[1])
      })) : (p[0] != 1 || p[1] != 1) && r.push(r.pop() + "scale(" + p + ")"), e = u.length,
      function(n) {
  ...
  function dr(n, t) {
    ...
    for (o < t.length && l.push(t.substring(o)), r = 0, i = f.length;
      (e = Ro.exec(n)) && i > r; ++r)
      if (a = f[r], a.x == e[0]) {
        if (a.i)
          if (l[a.i + 1] == null)
  ...
  function Nr(n, t) {
    var e;
    return arguments.length < 2 && (t = .45), arguments.length ? e = t / (2 * La) * Math.asin(1 / n) : (n = 1, e = t / 4),
      function(r) {
  ...
  function Xr(n, t, e) {
    ...
    if (n.charge = 0, !n.leaf)
      for (var i, a = n.nodes, o = a.length, c = -1; ++c < o;) i = a[c], null != i && (Xr(i, t, e), n.charge += i.charge, r += i.charge * i.cx, u += i.charge * i.cy);
    if (n.point) {
  ...
  function wu(n) {
    ...
    if ((e = n.children) && (l = e.length)) {
      var e, r, u, i, a, o, c, l, f = 1 / 0,
        ...
        h = 1 / 0,
        g = -1 / 0;
      if (e.forEach(Su), r = e[0], r.x = -r.r, r.y = 0, t(r), l > 1 && (u = e[1], u.x = u.r, u.y = 0, t(u), l > 2))
        for (i = e[2], Au(r, u, i), t(i), xu(r, i), r._pack_prev = i, xu(i, u), u = r._pack_next, a = 3; l > a; a++) {
          Au(r, u, i = e[a]);
          var p = 0,
            d = 1,
            m = 1;
          for (o = u._pack_next; o !== u; o = o._pack_next, d++)
            ...
            for (c = r._pack_prev; c !== o._pack_prev && !_u(c, i); c = c._pack_prev, m++);
  ...
  oa.bisectLeft = ga.left, oa.bisect = oa.bisectRight = ga.right, oa.shuffle = function(n) {
    ...
    for (var n = -1, e = oa.min(arguments, t), r = Array(e); ++n < e;)
      for (var u, i = -1, a = r[n] = Array(u); ++i < u;) a[i] = arguments[i][n];
    return r
  ...
  oa.selection = function() {
    ...
    for (var u = -1, i = this.length; ++u < i;)
      for (var a = this[u], o = -1, c = a.length; ++o < c;)(e = a[o]) && (r.push(t = va(n.call(e, e.__data__, o))), t.parentNode = e);
    return d(r)
  };
  var ka = {
  ...
  Za.forEach(function(n, t) {
    ...
    return "onload" in c ? c.onload = c.onerror = r : c.onreadystatechange = function() {
      ...
      if (arguments.length === 2 && "function" == typeof r && (i = r, r = null), c.open(e, n, !0), null == t || "accept" in a || (a.accept = t + ",*/*"), c.setRequestHeader)
  ...
  oa.geom.hull = function(n) {
    function t(n) {
      ...
      if (d === ze && r === De) t = n;
        ...
        for (i = 0, t = []; v > i; ++i) t.push([+d.call(this, u = n[i], i), +m.call(this, u, i)]);
  ...
  oa.ease = function(n) {
    ...
    return o.tick = function() {
      ...
      if (g)
        for (Xr(t = oa.geom.quadtree(m), r, a), e = -1; ++e < b;)(o = m[e]).fixed || t.visit(n(o));
  ...
  oa.layout.stack = function() {
    function n(o, c) {
      ...
      var h, g, p, d = r.call(n, f, c),
        ...
        v = l[0].length;
      for (g = 0; v > g; ++g)
        for (u.call(n, l[0][g], p = d[g], f[0][g][1]), h = 1; m > h; ++h) u.call(n, l[h][g], p += f[h - 1][g][1], f[h][g][1]);
      return o
    }
    var t = ft,
      e = nu,
  ...
  oa.layout.histogram = function() {
    function n(n, i) {
      ...
      if (g > 0)
        for (i = -1; ++i < h;) o = l[i], o >= f[0] && o <= f[1] && (a = c[oa.bisect(s, o, 1, g) - 1], a.y += p, a.push(n[i]));
      return c
    }
    var t = !0,
      e = Number,
