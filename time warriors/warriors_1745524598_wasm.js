  ...
  if (!ret) {
    switch (name_) {
      ...
      case 7938:
        ...
        if (GL.currentContext.version >= 2) glVersion = "OpenGL ES 3.0 (".concat(glVersion, ")");
        else {
...
var wasmImports = {
  ...
  pa: _emscripten_set_main_loop_arg,
  ...
  na: _glBindFramebuffer,
  C: _glBindRenderbuffer,
  h: _glBindTexture,
  ma: _glBindVertexArrayOES,
  ic: _glBlendEquation,
  ...
  Fa: _glCompressedTexImage3D,
  u: _glCompressedTexSubImage2D,
  ac: _glCompressedTexSubImage3D,
  la: _glCreateProgram,
  B: _glCreateShader,
  $b: _glCullFace,
  $: _glDeleteBuffers,
  _b: _glDeleteFramebuffers,
  _: _glDeleteProgram,
  t: _glDeleteRenderbuffers,
  s: _glDeleteShader,
  M: _glDeleteTextures,
  Zb: _glDeleteVertexArraysOES,
  Yb: _glDepthFunc,
  Xb: _glDepthMask,
  Ea: _glDetachShader,
  m: _glDisable,
  ...
  Tb: _glFlush,
  Sb: _glFramebufferRenderbuffer,
  Rb: _glFramebufferTexture2D,
  Qb: _glFrontFace,
  L: _glGenBuffers,
  Pb: _glGenFramebuffers,
  K: _glGenRenderbuffers,
  Y: _glGenTextures,
  Ob: _glGenVertexArraysOES,
  Nb: _glGetActiveAttrib,
  Mb: _glGetActiveUniform,
  ...
  r: _glShaderSource,
  Gb: _glStencilFunc,
  Fb: _glStencilFuncSeparate,
  Eb: _glStencilMask,
  Db: _glStencilOp,
  Cb: _glStencilOpSeparate,
  l: _glTexImage2D,
  Bb: _glTexImage3D,
  Ab: _glTexParameterf,
  k: _glTexParameteri,
  ...
  fa: _glViewport,
  wb: _glfwAccelerometerEnable,
  vb: _glfwCloseWindow,
  ub: _glfwDisable,
  tb: _glfwEnable,
  sb: _glfwGetAcceleration,
  ya: _glfwGetDefaultFramebuffer,
  rb: _glfwGetDisplayScaleFactor,
  qb: _glfwGetJoystickButtons,
  pb: _glfwGetJoystickDeviceId,
  ob: _glfwGetJoystickHats,
  T: _glfwGetJoystickParam,
  nb: _glfwGetJoystickPos,
  mb: _glfwGetKey,
  j: _glfwGetMouseButton,
  lb: _glfwGetMouseLocked,
  kb: _glfwGetMousePos,
  jb: _glfwGetMouseWheel,
  ib: _glfwGetWindowParam,
  hb: _glfwGetWindowRefreshRate,
  xa: _glfwGetWindowSize,
  gb: _glfwIconifyWindow,
  fb: _glfwInitJS,
  wa: _glfwOpenWindow,
  G: _glfwOpenWindowHint,
  eb: _glfwPollEvents,
  db: _glfwResetKeyboard,
  cb: _glfwSetCharCallback,
  bb: _glfwSetDeviceChangedCallback,
  ab: _glfwSetGamepadCallback,
  $a: _glfwSetMarkedTextCallback,
  _a: _glfwSetTouchCallback,
  Za: _glfwSetWindowBackgroundColor,
  Ya: _glfwSetWindowCloseCallback,
  Xa: _glfwSetWindowFocusCallback,
  Wa: _glfwSetWindowIconifyCallback,
  Va: _glfwSetWindowSize,
