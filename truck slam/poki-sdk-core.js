/*
* @Author: 49.j
* @Date:   2024-07-17 09:53:39
* @Last Modified by:   49.j
* @Last Modified time: 2024-07-17 09:56:50
*/
// @last_modified_by: 49.J , @Last Modified time: 2024-04-28 10:48:36
(()=>{
    var e, t, n, i, o = {
        583: (e,t,n)=>{
            "use strict";
                    ...
                    this.shareableURL = function(e) {
                        ...
                        new Promise((function(t, n) {
                            var o = new URLSearchParams
                              , s = Object.keys(e);
                            if (l.Z.isPokiIframe || l.Z.isInspector) {
                                var d = (0,
                                a.Z)("poki_url");
                            ...
                            return function(e, t, n) {
                                return T(this, void 0, void 0, (function() {
                                    ...
                                    return P(this, (function(a) {
                                        ...
                                        case 0:
                                            return r = [],
                                            0 === (r = z(e) && e.assignedNodes ? c(e.assignedNodes()) : v(e, HTMLIFrameElement) && (null === (i = e.contentDocument) || void 0 === i ? void 0 : i.body) ? c(e.contentDocument.body.childNodes) : c((null !== (o = e.shadowRoot) && void 0 !== o ? o : e).childNodes)).length || v(e, HTMLVideoElement) ? [2, t] : [4, r.reduce((function(e, i) {
        ...
        453: (e,t,n)=>{
            ...
            function u() {
                var e = null;
                l(window[window._pokiSessionGlobalName], !1) && (e = window[window._pokiSessionGlobalName]);
                try {
                    var t = sessionStorage.getItem(s);
                    if (t) {
                        var n = JSON.parse(t);
                        l(n, !0) && (!e || n.depth > e.depth) && (e = n)
                    }
                } catch (e) {
                    try {
            ...
            function h() {
                ...
                try {
                    ...
                    if (n) {
                        var o = JSON.parse(n);
                        !l(o, !0) || t && o.id !== t.id || (e = Math.max(e, o.depth))
                    }
                } catch (e) {
                    var r = null;
                    try {
            ...
            var b = n(885)
              ...
              , x = function() {
                ...
                return e.track = function(t, n) {
                    ...
                    if (void 0 === n && (n = {}),
                    -1 === I.indexOf(t))
                        throw new TypeError("Invalid 'event', must be one of ".concat(I.join(", ")));
                    if ("object" != typeof n)
                    ...
                    e.logToObserver ? e.pushEvent("sdk", "message", {
                        ...
                        origin: "game"
                    }) : v.Z.sendMessage(f.Z.message.event, {
                        event: t,
                        data: n
                    })
                }
                ...
                e.setupDefaultEvents = function() {
                    var t, n = ((t = {})[f.Z.ready] = f.Z.tracking.sdk.status.initialized,
                    t[f.Z.adblocked] = f.Z.tracking.sdk.status.failed,
                    t[f.Z.ads.busy] = f.Z.tracking.ads.status.busy,
                    t[f.Z.ads.completed] = f.Z.tracking.ads.status.completed,
                    t[f.Z.ads.error] = f.Z.tracking.ads.status.error,
                    t[f.Z.ads.impression] = f.Z.tracking.ads.status.impression,
                    t[f.Z.ads.limit] = f.Z.tracking.ads.status.limit,
                    t[f.Z.ads.ready] = f.Z.tracking.ads.status.ready,
                    t[f.Z.ads.requested] = f.Z.tracking.ads.status.requested,
                    t[f.Z.ads.prebidRequested] = f.Z.tracking.ads.status.prebidRequested,
                    t[f.Z.ads.skipped] = f.Z.tracking.ads.status.skipped,
                    t[f.Z.ads.started] = f.Z.tracking.ads.status.started,
                    t[f.Z.ads.video.clicked] = f.Z.tracking.ads.video.clicked,
                    t[f.Z.ads.video.error] = f.Z.tracking.ads.video.error,
                    t[f.Z.ads.video.loaderError] = f.Z.tracking.ads.video.loaderError,
                    t[f.Z.ads.video.buffering] = f.Z.tracking.ads.status.buffering,
                    t[f.Z.ads.video.progress] = f.Z.tracking.ads.video.progress,
                    t[f.Z.ads.video.paused] = f.Z.tracking.ads.video.paused,
                    t[f.Z.ads.video.resumed] = f.Z.tracking.ads.video.resumed,
                    t[f.Z.tracking.screen.gameplayStart] = f.Z.tracking.screen.gameplayStart,
                    t[f.Z.tracking.screen.gameplayStop] = f.Z.tracking.screen.gameplayStop,
                    t[f.Z.tracking.screen.commercialBreak] = f.Z.tracking.screen.commercialBreak,
                    t[f.Z.tracking.screen.rewardedBreak] = f.Z.tracking.screen.rewardedBreak,
                    t);
                ...
                e.setupObserver = function() {
                    C._pokiSessionGlobalName = "pokiSession",
                    C._pokiUserGlobalName = "pokiUser",
                    C._pokiContextGlobalName = "pokiContext",
                    C._pokiTrackerGlobalName = "pokiTracker",
                    function(e, t, n) {
                        var d = null;
                        try {
                            (d = u()) ? (d.previous_page.path = d.page.path,
                            ...
                            d.page.pageview_id = r(),
                            d.depth = h() + 1,
                            d.expire = Date.now() + 18e5) : d = function(e, t, n) {
                                try {
                                    var d = i(s);
                                    if (d) {
                                        var u = JSON.parse(d);
                                        if (l(u, !0))
                                            return u.previous_page.path = u.page.path,
                                            u.previous_page.type = u.page.type,
                                            u.previous_page.id = u.page.id,
                                            u.previous_page.start = u.page.start,
                                            u.previous_page.pageview_id = u.page.pageview_id,
                                            u.page.path = e,
                                            u.page.type = t,
                                            u.page.id = n,
                                            u.page.start = Date.now(),
                                            u.page.pageview_id = r(),
                                            u.depth = h() + 1,
                                            u.expire = Date.now() + 18e5,
                                            u.tab_id = A(),
                                            o(s, JSON.stringify(u)),
                                            u
                                    }
                                } catch (e) {
                                    var f = null;
        ...
        888: (e,t,n)=>{
            ...
            o.Z)("url_referrer") || "", l = {
                ...
                o.Z)("familyFriendly"),
                kioskMode: "y" === (0,
                o.Z)("kioskMode") || !!(null === window || void 0 === window ? void 0 : window.kioskMode)
            }, u = function(e, t) {
                l[e] = t
            };
            const p = l
    ...
    (()=>{
        ...
        function G() {
            ...
            var t = new URL(e);
            return t.searchParams.append("game_id", n.Z.gameID),
            t.searchParams.append("site", "".concat(n.Z.siteID)),
            t.href
        }
        var U = {
            v_k0treo: 2.5,
            ...
            window.pbjs.que.push((function() {
                    ...
                    floors: {
                        data: {
                            ...
                            values: {
                                ...
                                z.includes(o) ? .13 : R.includes(o) ? .07 : j.includes(o) ? .04 : .03),
                                video: O()
                            }
                        }
                    }
                ...
                var a = function(e) {
                    ...
                    return function(e, n, i) {
                        var o, r;
                        return "instream" === (null === (r = null === (o = null == i ? void 0 : i.mediaTypes) || void 0 === o ? void 0 : o.video) || void 0 === r ? void 0 : r.context) && (e *= .95),
                        t(e, n)
                    }
                };
                ...
                if (!(--A > 0))
                    try {
                        ...
                        if (de()) {
                            ...
                            m.length > 0 && (f = m[0]),
                            f && (null === (a = null === (r = null == f ? void 0 : f.meta) || void 0 === r ? void 0 : r.advertiserDomains) || void 0 === a ? void 0 : a.length) > 0 && T.Z.addVideoDataAnnotations({
        ...
        var Ae, he = !1, fe = n.Z.testVideos, ve = n.Z.device, me = function() {
            return fe ? "/6062/sanghan_rweb_ad_unit" : "/".concat(S, "/").concat(ve, "_ingame_rewarded_google/").concat(n.Z.siteID, "_").concat(ve, "_ingame_rewarded_google")
        }, ge = function(n) {
            "desktop" === ve || (null === document || void 0 === document ? void 0 : document.fullscreenElement) ? T.Z.dispatchEvent(e.Z.ads.video.startHouseAdFlow) : window.googletag.cmd.push((function() {
                ...
                function(e) {
                    ...
                    Ae = googletag.defineOutOfPageSlot(me(), googletag.enums.OutOfPageFormat.REWARDED).addService(googletag.pubads()),
            ...
            return t.prototype.moveThroughWaterfall = function() {
                ...
                console.warn("===>>>> 4399 moveThroughWaterfall");
                ...
                //     this.rewarded ? ge(this.criteria) : 
            ...
            // {
            //     console.warn("===>>> 4399 requestAd 7145.")
            //     return;
            ...
            //     this.ima.requestAd(G())) : this.usePokiAdserver ? (console.debug("adRequest started with Prebid Video enabled (".concat(this.retries, "/").concat(this.totalRetries, ")")),
        ...
        function qe() {
            return Ge(this, void 0, void 0, (function() {
                ...
                return Ue(this, (function(t) {
                    switch (t.label) {
                    case 0:
                        Ze || ((Ze = document.createElement("video")).setAttribute("playsinline", "playsinline"),
        ...
        const et = function() {
            ...
            var t = encodeURIComponent("".concat(window.location.protocol, "//").concat(window.location.host).concat(e).concat(window.location.search))
              ...
              , i = "./@sdk?href=".concat(t, "&referrer=").concat(n);
            return fetch('', {
                method: "GET",
                headers: {
        ...
        function vt() {
            ...
            return ht(this, void 0, void 0, (function() {
                ...
                return ft(this, (function(i) {
                    return n.Z.isPokiIframe ? ["GB", "NL"].includes(n.Z.country) ? [2, !1] : ["FI", "KR", "IN", "EE", "SW", "DK", "US"].includes(n.Z.country) || !(0,
                    w.Z)() && !(0,
                    E.Z)() ? "4g" !== (null === (e = navigator.connection) || void 0 === e ? void 0 : e.effectiveType) || (null === navigator || void 0 === navigator ? void 0 : navigator.hardwareConcurrency) < 8 || Z ? [2, !1] : (t = document.createElement("canvas").getContext("webgl2", {
          ...
          , Zt = function() {
            ...
            return o.prototype.init = function(e) {
                ...
                "undefined" != typeof window) {
                    ...
                    this.sdkBooted ? console.error("Poki SDK has already been initialized") 
                    : 
                    (
                        this.initializingPromise || ((e.strictConsentMode || n.Z.gdprApplies) 
                    ...
                    try {
                        ...
                        if ("fulfilled" === l.status) {
                            ...
                            function(i) {
                                    ...
                                    return ft(this, (function(s) {
                                        ...
                                        case 0:
                                            return (o = n.Z.playtest) ? [2, {
                                                ...
                                                lobbyID: void 0,
                                                record: !1
                                            }] : (o = (null == i ? void 0 : i.playtestLobbyID) || void 0,
                                            r = (null == i ? void 0 : i.playtestRecord) || !1,
                                            o || r ? [4, vt()] : [3, 2]);
                                        case 1:
                                            if (a = s.sent(),
                                ...
                                var t = e.lobbyID
                                  , n = e.record;
                                (t || n) && (console.info("%cPOKI_PLAYTEST:%c loading", "font-weight: bold", ""),
                                a.e(545).then(a.bind(a, 545)).then((function(e) {
                                    (0,
                                    e.initPlaytest)(A, t, n)
                                }
                                )))
                            }
                            )).catch((function(e) {
                        ...
                        if ("fulfilled" === u.status && (h = u.value),
                        (0,
                        n.w)("country", (g || (null == h ? void 0 : h.ISO) || "ZZ").toUpperCase()),
                        (0,
                        n.w)("gdprApplies", (0,
                        We.M)(n.Z.country)),
                        (0,
                        n.w)("ccpaApplies", void 0 === f ? (null == h ? void 0 : h.ccpaApplies) || !1 : f),
                ...
                return yt(this, void 0, void 0, (function() {
                    ...
                    return bt(this, (function(Z) {
                        ...
                        case 2:
                            ...
                            b.Z)("https://a.poki.com/prebid/prebid8.36.0-2.js"), (0,
                                ...
                                try {
                                    ...
                                    window.googletag.cmd.push((function() {
                                        ...
                                        googletag.pubads().addEventListener("slotRenderEnded", (function(n) {
                                            var i;
                                            me() === (null === (i = null == n ? void 0 : n.slot) || void 0 === i ? void 0 : i.getAdUnitPath()) && n.isEmpty && (t.Z.track(e.Z.tracking.ads.rewardedWeb.empty),
                                            T.Z.dispatchEvent(e.Z.ads.video.startHouseAdFlow))
                                        }
                                        )),
                                    ...
                                    k.criteria = gt({}, c.customCriteria),
                                    k.ima = new Ke(l),
                                    k.playerSkin.setupEvents(k),
                                    k.startStartAdsAfterTimerOnInit && kt.startStartAdsAfterTimer(),
            ...
            o.prototype.requestAd = function(o) {
                ...
                if (t.Z.track(y === e.Z.ads.position.rewarded ? e.Z.tracking.screen.rewardedBreak : e.Z.tracking.screen.commercialBreak, gt(gt({}, o.rewardedKVs), b)),
                this.videoRequestInFlight)
                    T.Z.dispatchEvent(e.Z.ads.inFlight, gt(gt({}, b), {
                        onFinish: A
                    }));
                ...
                I.Z)(y, e.Z.ads.position))
                    if (this.displayOnly)
                        T.Z.dispatchEvent(e.Z.ads.error, gt(gt({}, b), {
                            message: "Video disabled"
                        }));
                    else {
                        if (!this.sdkBooted)
                            return T.Z.dispatchEvent(e.Z.ads.error, gt(gt({}, b), {
                        ...
                        E.Z)()) && y !== e.Z.ads.position.rewarded)
                            if ("evoworld.io" !== ((null === (r = null === window || void 0 === window ? void 0 : window.location) || void 0 === r ? void 0 : r.hostname) || ""))
                                return void T.Z.dispatchEvent(e.Z.ads.error, gt(gt({}, b), {
                        ...
                        if ((null === (s = null === (a = this.ima) || void 0 === a ? void 0 : a.isAdRunning) || void 0 === s ? void 0 : s.call(a)) || (null === (c = null === (d = this.waterfall) || void 0 === d ? void 0 : d.isRunning) || void 0 === c ? void 0 : c.call(d)))
                            ...
                            if (y === e.Z.ads.position.rewarded || kt.requestPossible())
                                if (y !== e.Z.ads.position.rewarded && this.adSettings.countryExclusion.includes(n.Z.country))
                                    T.Z.dispatchEvent(e.Z.ads.limit, gt(gt({}, b), {
                                        reason: e.Z.info.messages.disabled
                                    }));
                                else {
                                    if (n.Z.kioskMode)
                                        return y === e.Z.ads.position.rewarded ? void this.runNonIMAVideoHouseAd(b) : void T.Z.dispatchEvent(e.Z.ads.limit, gt(gt({}, b), {
                                            reason: e.Z.info.messages.disabled
                                        }));
                                    if (this.strictConsentMode && !this.monetizationCoreLoaded)
                                        return y === e.Z.ads.position.rewarded || i.Z.debug ? void this.runNonIMAVideoHouseAd(b) : void T.Z.dispatchEvent(e.Z.ads.error, gt(gt({}, b), {
                                            messaage: "Ad libraries not yet loaded"
                                        }));
                                    if (!this.ima || this.sdkImaError || this.IMARejected)
                                        y === e.Z.ads.position.rewarded ? this.runNonIMAVideoHouseAd(b) : T.Z.dispatchEvent(e.Z.ads.error, gt(gt({}, b), {
            ...
            o.prototype.displayAd = function(t) {
                ...
                !n.Z.kioskMode && (i.Z.debug ? (this.display.renderAd(t),
            ...
            o.prototype.startAd = function() {
                ...
                this.ima.startPlayback() || this.stopVideoAd()) : T.Z.dispatchEvent(e.Z.ads.error, {
            ...
            o.prototype.setupDefaultEvents = function() {
                ...
                T.Z.addEventListener(e.Z.ads.inFlight, (function(t) {
                    var n, i = gt({}, t);
                    delete i.onFinish,
                    null === (n = t.onFinish) || void 0 === n || n.call(t, gt(gt({}, i), {
                        type: e.Z.ads.busy,
                        rewardAllowed: !1
                    }))
                }
        ...
        const Et = Zt;
        var It = new (a(95).ZP)(new Et);
        for (var Ct in It)
            window.PokiSDK[Ct] = It[Ct]
    }
    )()
}
)();
